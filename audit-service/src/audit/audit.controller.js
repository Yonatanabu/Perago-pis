...
var AuditController = /** @class */ (function () {
     ...
     */
    AuditController.prototype.handlePositionCreated = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.auditService.handlePositionCreated(payload)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    __decorate([
        (0, microservices_1.EventPattern)('position.created'),
        __param(0, (0, microservices_1.Payload)())
    ], AuditController.prototype, "handlePositionCreated");
    __decorate([
        (0, common_1.Get)(),
        (0, swagger_1.ApiOperation)({ summary: 'Retrieve all audit log entries, newest first' })
