...
var AuditService = /** @class */ (function () {
    function AuditService(auditLogRepository) {
     ...
     */
    AuditService.prototype.handlePositionCreated = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var message, log;
            return __generator(this, function (_a) {
                message = "[".concat(payload.name, "] is created at [").concat(payload.createdAt, "]");
                console.log("\uD83D\uDCCB Audit: ".concat(message));
