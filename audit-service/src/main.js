    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    app = _a.sent();
                    // Allow the frontend (Next.js on :3000) to access the audit API
                    app.enableCors({
                ...
                case 3:
                    _a.sent();
                    console.log("\uD83D\uDFE2 Audit Service HTTP  \u2192 http://localhost:".concat(process.env.PORT || 3001));
                    console.log("\uD83D\uDFE2 Audit Service Swagger \u2192 http://localhost:".concat(process.env.PORT || 3001, "/api-docs"));
